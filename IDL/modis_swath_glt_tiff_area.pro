...
pro modis_swath_glt_tiff_area
  ...
  output_directory='D:/Experiments/MODIS_DataProcessing/Data/Results/OutTiff_TW'
  ...
  for file_i=0,file_n-1 do begin
    ...
    pos=where((modis_lon_data ge 120.0) and (modis_lon_data le 121.0) and (modis_lat_data ge 22.0) and (modis_lat_data le 23.0),count)
